...
The dataset was created by scraping an online book catalog website and cleaned for analysis.
...
Collected book data including title, price, rating, and stock availability using Python.

Data Cleaning

Cleaned and structured the scraped data to prepare it for analysis.

Exploratory Data Analysis

Analyzed price ranges, rating distributions, and genre patterns.
...
•	The dataset contains 780 books with an average price of $35.1.

•	Book prices are relatively consistent across genres.

•	Ratings are balanced across categories such as Good, Very Good, and Excellent.

•	Higher priced books do not consistently receive higher ratings.

•	Mid-priced books often provide similar ratings to expensive books.
